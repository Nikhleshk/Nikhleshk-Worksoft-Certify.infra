...
variable "key_vault_uri" {
  description = "Key Vault uri for storing and fetching secrets"
  default     = ""
}
...
variable "auditing_to_storageaccount" {
  description = "Audit to Storage Account too in addition to log analytics"
  default     = false
}
